...
export PATH_MAPPING='/usr/share/virt-manager:${SHARUN_DIR}/share/virt-manager,/usr/lib/libvirt:${SHARUN_DIR}/lib/libvirt./usr/share/libvirt:${SHARUN_DIR}/share/libvirt,/usr/bin:${SHARUN_DIR}/bin'
